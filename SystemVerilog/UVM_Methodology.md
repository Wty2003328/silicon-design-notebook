...
Interview one-liner: *RAL decouples "which register/field am I touching" from "which bus carries it"* — the same test runs on APB today and AXI tomorrow by swapping the adapter ([AHB_AXI_APB](../Architecture/AHB_AXI_APB.md)).
...
- Bus knowledge for agents: [AHB_AXI_APB](../Architecture/AHB_AXI_APB.md), [ACE_and_CHI](../Architecture/ACE_and_CHI.md).
- Formal complement: [Formal_Verification](../Implementation/Formal_Verification.md) (what UVM shouldn't be used for).
