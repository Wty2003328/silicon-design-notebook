...
> **Hands off to:** [Power_Analysis_and_Signoff](05_Power_Analysis_and_Signoff.md) (SAIF/VCD annotation mechanics, IR-drop signoff), [Power_Reduction_Techniques](03_Power_Reduction_Techniques.md) (what to *do* about a high-activity net), [Full_Chip_Modeling](../01_Architecture_and_PPA/04_SoC_and_Chiplet_Architecture/01_System_Modeling/01_Full_Chip_Modeling.md) (composing block power into a chip).
...
The mechanics of the activity files themselves — SAIF's backward/forward annotation, the toggle/time-at-1 fields, VCD/FSDB capture — are in [Power_Analysis_and_Signoff §2](05_Power_Analysis_and_Signoff.md). Composing these per-block estimates into a full chip, with the contention and DVFS-budget layers that make it more than a sum, is [Full_Chip_Modeling](../01_Architecture_and_PPA/04_SoC_and_Chiplet_Architecture/01_System_Modeling/01_Full_Chip_Modeling.md).
