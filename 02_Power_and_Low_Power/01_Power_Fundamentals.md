...
- **Adjacent (where the budget meets architecture):** [Performance_Modeling_and_DSE](../01_Architecture_and_PPA/01_Modeling/01_Performance_Modeling_and_DSE.md) (the power half of PPA and the $P\sim f^3$ DVFS lever), [Full_Chip_Modeling](../01_Architecture_and_PPA/01_Modeling/02_Full_Chip_Modeling.md) (composing DVFS/thermal across a chip), [OoO_Execution](../01_Architecture_and_PPA/02_CPU/03_OoO_Execution.md) (the wakeup/RF power that made the scheduler the $\sim W^2$ hot spot), [GPU_Architecture](../01_Architecture_and_PPA/05_GPU/01_GPU_Architecture.md) & [NPU_Accelerators](../01_Architecture_and_PPA/06_NPU/01_NPU_Accelerators.md) (the wide-and-slow / data-movement thesis of §5.1 and §2.2), [Memory](../01_Architecture_and_PPA/03_Memory/03_Memory.md) (SRAM access and array-leakage budgets).
