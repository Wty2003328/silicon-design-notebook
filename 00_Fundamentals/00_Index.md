# 00 · Fundamentals — Folder Index

*Device physics, logic, and arithmetic the rest of the flow assumes.*

| # | Page | Coverage |
|---|------|----------|
| 01 | [CMOS Fundamentals](01_CMOS_Fundamentals.md) | MOSFET, inverter VTC, noise margins, delay, logic families, I/O signaling standards (LVCMOS/SSTL/POD/LVDS/CML), latch-up, ESD, FinFET, 6T SRAM, leakage |
