...
*(This section owns the transistor-level SRAM foundation that [Memory](../01_Architecture_and_PPA/05_Architecture_Foundations_and_Methods/04_Hardware_Structures/01_Memory_Arrays_and_Technologies.md) reasons above; that page defers its bitcell, butterfly-curve, and margin derivations here.)*
