...
- Produced from: [Synthesis_and_Optimization](Synthesis_and_Optimization.md) — the command-level SDC reference on this page was moved here from its §2.
- Worked signoff-side walkthrough of a complete SDC on a realistic SoC block: [STA](../06_Signoff/STA.md) §10. Clocks: [Clock_Division_and_Switching](../03_Frontend_RTL_and_Verification/Clock_Division_and_Switching.md). Async groups → [Lint_CDC_RDC_Signoff](../03_Frontend_RTL_and_Verification/Lint_CDC_RDC_Signoff.md).
