...
├── 01_Architecture_and_PPA/       5 chip-architecture books, 28 subdomains, 46 chapters
...
Pages are numbered in reading order within each domain and subdomain, and every level has a `00_Index.md` defining ownership, reading order, and handoffs. The architecture section is organized as CPU, GPU, NPU, SoC/chiplet, and shared-method books; chip-specific topics live with the architecture that owns their design decisions. Total: **79 flow pages + 10 interview-prep banks**.
