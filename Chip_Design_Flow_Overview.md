...
| **01 · Architecture + PPA** | explore µarch; model performance; budget power/area | [Performance Modeling & DSE](01_Architecture_and_PPA/01_Modeling/01_Performance_Modeling_and_DSE.md), [CPU Architecture](01_Architecture_and_PPA/02_CPU/01_CPU_Architecture.md), [OoO](01_Architecture_and_PPA/02_CPU/03_OoO_Execution.md), [Cache](01_Architecture_and_PPA/03_Memory/01_Cache_Microarchitecture.md), [NoC](01_Architecture_and_PPA/04_Interconnect/03_Network_on_Chip.md), [DDR](01_Architecture_and_PPA/03_Memory/04_DDR_Controller.md) |
