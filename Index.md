...
*Explore each chip architecture as a coherent book, including its own workload, performance, physical-design, PPA, and simulation methods before register-transfer level (RTL) implementation. The section contains **57 chapters in 26 focused subdomains**.*
...
| [GPU Architecture](01_Architecture_and_PPA/02_GPU_Architecture/00_Index.md) | [GPU workload, DSE, PPA, and simulation methods](01_Architecture_and_PPA/02_GPU_Architecture/00_Design_Methodology/00_Index.md) → [core architecture, operand delivery, independent-thread scheduling, and asynchronous pipelines](01_Architecture_and_PPA/02_GPU_Architecture/01_Core_Architecture/00_Index.md) → [GPU memory and high-bandwidth memory](01_Architecture_and_PPA/02_GPU_Architecture/02_Memory_System/00_Index.md) → [multi-GPU scale-up](01_Architecture_and_PPA/02_GPU_Architecture/03_Scale_Up/00_Index.md) → [GPU simulation](01_Architecture_and_PPA/02_GPU_Architecture/04_Simulation/00_Index.md). |
