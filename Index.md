...
| [09 · Memory](01_Architecture_and_PPA/09_Memory.md) | 6T/8T/10T SRAM (transistor-level), DRAM cell + refresh, memory compiler, multi-port SRAM, register files, ECC, CAM/TCAM, CIM |
