...
> Prerequisites: [OOP_and_Randomization](OOP_and_Randomization.md) (classes, polymorphism, constraints), [Procedural_and_Processes](Procedural_and_Processes.md) (fork/join, mailboxes/events and the pre-UVM testbench), [Assertions_and_Coverage](Assertions_and_Coverage.md) (the checking layer UVM orchestrates).
...
*Sections 10–16 are the deep-dive reference (merged from the retired IPC & Verification deep-dive page): production-grade expansions of §4–§8 with complete, runnable code. The raw mailbox/semaphore/event primitives that UVM's TLM replaces now live in [Procedural_and_Processes](Procedural_and_Processes.md).*
...
- Language mechanics underneath: [OOP_and_Randomization](OOP_and_Randomization.md) (factory = polymorphism + registry; constraints), [Procedural_and_Processes](Procedural_and_Processes.md) (raw mailboxes/events vs TLM).
