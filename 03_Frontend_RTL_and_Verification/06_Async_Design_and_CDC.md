...
*Device-level first-principles (two cross-coupled inverters as an unstable equilibrium): [Logic_Building_Blocks](../00_Fundamentals/02_Logic_Building_Blocks.md) §Metastability.*
