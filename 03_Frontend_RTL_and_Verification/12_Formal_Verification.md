...
- **Domain sweet spots** worth naming, all instances of "small control / deep corners": **cache-coherence** protocols ([Cache_Microarchitecture](../01_Architecture_and_PPA/03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md), [ACE_and_CHI](../01_Architecture_and_PPA/04_Interconnect/01_Protocols/02_ACE_and_CHI.md)), **NoC deadlock/livelock freedom** ([Network_on_Chip](../01_Architecture_and_PPA/04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md)), and **ISA compliance** via the open riscv-formal framework ([RISC_V_ISA](../01_Architecture_and_PPA/02_CPU/01_Core_Foundations/02_RISC_V_ISA.md)). For wide accelerator datapaths (tensor cores, GEMM arrays) formal is used only *with* datapath abstraction (§6.2) — prove a 4-bit tile, argue up — with the wide arithmetic left to simulation.
...
- **Formal sweet-spot domains:** [Cache_Microarchitecture](../01_Architecture_and_PPA/03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) & [ACE_and_CHI](../01_Architecture_and_PPA/04_Interconnect/01_Protocols/02_ACE_and_CHI.md) (coherence corner cases), [Network_on_Chip](../01_Architecture_and_PPA/04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md) (deadlock freedom), [RISC_V_ISA](../01_Architecture_and_PPA/02_CPU/01_Core_Foundations/02_RISC_V_ISA.md) (ISA-compliance formal), [OoO_Execution](../01_Architecture_and_PPA/02_CPU/03_Out_of_Order_Backend/01_OoO_Execution.md) (control-heavy precise-exception logic).
