...
- **Down the stack (the physics these types model):** [CMOS_Fundamentals](../00_Fundamentals/01_CMOS_Fundamentals.md) (the transmission gate and floating node behind Z, §5.2), [Logic_Building_Blocks](../00_Fundamentals/02_Logic_Building_Blocks.md) (the mux X-propagates through, the latch that X exposes), [Memory](../01_Architecture_and_PPA/09_Memory.md) (the array an unpacked type infers).
