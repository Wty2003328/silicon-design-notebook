...
- **Up the stack (what consumes PnR's geometry):** [STA](../06_Signoff/01_STA.md) (turns extracted RC into signed-off slack; OCV/AOCV/POCV, SI timing, MCMM), [Signal_Integrity_Reliability](02_Signal_Integrity_Reliability.md) (crosstalk, electromigration, IR-drop *analysis* on the routed geometry), [Power_Analysis_and_Signoff](../02_Power_and_Low_Power/06_Power_Analysis_and_Signoff.md) (power-grid robustness and IR-drop signoff), [Physical_Verification_DRC_LVS](../06_Signoff/03_Physical_Verification_DRC_LVS.md) (DRC, LVS, antenna, DFM — the gate to GDSII).
