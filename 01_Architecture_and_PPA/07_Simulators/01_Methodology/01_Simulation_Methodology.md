...
> **Prerequisites:** [Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (the analytical leaf models a simulator makes executable), [Full_Chip_Modeling](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md) (the tool/fidelity ladder this page explains conceptually).
...
3. **Physical — "what does it cost?"** Overlay energy, power, area, temperature onto the timed activity. This is the McPAT / Accelergy / DRAMPower / HotSpot layer covered in [Full_Chip_Modeling](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md).
...
The theoretical backbone across all of it is **queueing**: a shared resource of service rate $\mu$ under offered load $\lambda$ has utilization $\rho=\lambda/\mu$, and mean latency grows as $\sim 1/(1-\rho)$ — latency runs to the knee as you approach saturation. Every credible memory/NoC simulator is, at bottom, a structural realization of that curve; a model that reports latency flat with load has no queue and is optimistic. (DRAM device/controller detail: [Memory](../../03_Memory/04_Memory_Technologies/01_Memory_Arrays_and_Technologies.md), [DDR_Controller](../../03_Memory/05_Main_Memory/01_DDR_Controller.md).)
...
- **Calibration** fits free parameters (latencies, penalties, McPAT's technology knobs) to close the gap; an *un-calibrated* architectural model can be 2× off, a calibrated one ~20–30% (see the [Full_Chip_Modeling §1.7 accuracy ladder](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md)).
...
- **Down the stack:** [Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (analytical kernels + the NeuSim worked example), [OoO_Execution](../../02_CPU/03_Out_of_Order_Backend/01_OoO_Execution.md) (the structures an O3 timing model tracks), [Memory](../../03_Memory/04_Memory_Technologies/01_Memory_Arrays_and_Technologies.md) / [DDR_Controller](../../03_Memory/05_Main_Memory/01_DDR_Controller.md) (what DRAM simulators encode).
- **Up the stack:** [Full_Chip_Modeling](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md) (composing leaf models into a chip; the full tool/fidelity ladder and the perf→power→thermal loop).
- **Sibling pages (this folder):** per-tool deep dives — [gem5](../02_CPU_and_System/01_gem5.md) (the event engine + O3 cost model of §3/§6 made concrete), [DRAM_Simulators](../03_Memory_and_Interconnect/01_DRAM_Simulators.md) (the banks/scheduler realizing §7's bandwidth-as-output), [GPU_Simulators](../04_Accelerator_Simulation/01_GPU_Simulators.md), [Accelerator_and_NPU_Simulators](../04_Accelerator_Simulation/02_Accelerator_and_NPU_Simulators.md), [Other_Architecture_Simulators](../05_Specialized_Simulators/01_Other_Architecture_Simulators.md), and [Analytical_Models](02_Analytical_Models.md) (the closed-form dual of §6's interval model). Folder [index](../00_Index.md).
...
⬅ [Simulators Index](../00_Index.md) · [Architecture Book Contents](../../00_Index.md) · next ➡ [gem5](../02_CPU_and_System/01_gem5.md)
