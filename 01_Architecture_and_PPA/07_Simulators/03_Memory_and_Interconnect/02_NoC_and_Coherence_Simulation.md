# NoC and Coherence Simulation — Coupling Protocol State to Contended Transport

> **Prerequisites:** [Simulation Methodology](../01_Methodology/01_Simulation_Methodology.md), [Cache Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md), [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md), and [Routing, Flow Control, and Deadlock](../../04_Interconnect/02_Network_on_Chip/02_Routing_Flow_Control_and_Deadlock.md).
...
- **Method/tool:** [Simulation Methodology](../01_Methodology/01_Simulation_Methodology.md), [gem5](../02_CPU_and_System/01_gem5.md), [Other Architecture Simulators](../05_Specialized_Simulators/01_Other_Architecture_Simulators.md).
- **Subjects:** [Cache Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md), [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md), [Routing, Flow Control, and Deadlock](../../04_Interconnect/02_Network_on_Chip/02_Routing_Flow_Control_and_Deadlock.md).
...
**Navigation:** [Memory and Interconnect Simulation index](00_Index.md) · [Simulators index](../00_Index.md)
