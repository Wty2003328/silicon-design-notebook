...
> **Prerequisites:** [CPU_Architecture](03_CPU_Architecture.md) (in-order pipeline, hazards), [Adders_and_Multipliers](../00_Fundamentals/03_Adders_and_Multipliers.md), [RISC_V_ISA](04_RISC_V_ISA.md).
> **Hands off to:** [Branch_Prediction_Deep_Dive](06_Branch_Prediction_Deep_Dive.md), [Cache_Microarchitecture](07_Cache_Microarchitecture.md), [Xiangshan_CPU_Design](14_Xiangshan_CPU_Design.md).
...
- **Up the stack (what builds on it):** [Branch_Prediction_Deep_Dive](06_Branch_Prediction_Deep_Dive.md) (drives the front end and sets the §3.2 branch horizon and §6 penalty), [Cache_Microarchitecture](07_Cache_Microarchitecture.md) & [TLB_and_Virtual_Memory](08_TLB_and_Virtual_Memory.md) (the memory system the LSQ and AGU talk to; the $L_{miss}$ of §3.2), [Xiangshan_CPU_Design](14_Xiangshan_CPU_Design.md) (a complete open OoO core composing every structure here), [Performance_Modeling_and_DSE](01_Performance_Modeling_and_DSE.md) (where these window-sizing models feed design-space exploration).
- **Adjacent / prerequisite:** [CPU_Architecture](03_CPU_Architecture.md) (the in-order pipeline and hazards this relaxes), [RISC_V_ISA](04_RISC_V_ISA.md) (the architectural namespace being renamed and the trap model of §9).
