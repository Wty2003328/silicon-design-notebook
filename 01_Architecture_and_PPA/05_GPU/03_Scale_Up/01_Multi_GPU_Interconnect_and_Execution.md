# Multi-GPU Interconnect and Execution — When Communication Becomes the Roofline

> **Prerequisites:** [GPU Architecture](../01_Core_Architecture/01_GPU_Architecture.md), [GPU Memory System](../02_Memory_System/01_Coalescing_Caches_and_Shared_Memory.md), [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md), and basic parallel-program decomposition.
...
- **Single-device roots:** [GPU Architecture](../01_Core_Architecture/01_GPU_Architecture.md), [GPU Memory System](../02_Memory_System/01_Coalescing_Caches_and_Shared_Memory.md), [HBM](../../03_Memory/05_Main_Memory/02_HBM_and_Advanced_Memory_Systems.md).
- **Fabric:** [Chiplets, CXL, and Die-to-Die](../../04_Interconnect/03_System_Fabrics/02_Chiplets_CXL_and_Die_to_Die.md), [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md).
- **Modeling:** [Full-Chip Modeling](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md), [Performance Modeling and DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md).
