# SIMT Scheduling and Occupancy — Hiding Latency with Resident Warps

> **Prerequisites:** [GPU Architecture](01_GPU_Architecture.md) (SIMT/SM overview), [SMT, SIMD, and Vector Execution](../../02_CPU/01_Core_Foundations/03_SMT_SIMD_and_Vector_Execution.md), and basic CUDA-like thread/block terminology.
...
- **Parallelism relatives:** [SMT, SIMD, and Vector Execution](../../02_CPU/01_Core_Foundations/03_SMT_SIMD_and_Vector_Execution.md), [Systolic, Spatial, and Vector Dataflows](../../06_NPU/01_Compute_Dataflows/02_Systolic_Spatial_and_Vector_Dataflows.md).
- **Simulation:** [GPU Simulators](../../07_Simulators/04_Accelerator_Simulation/01_GPU_Simulators.md).
