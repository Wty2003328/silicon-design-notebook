...
- **Adjacent / device detail:** [Memory](../03_Memory/03_Memory.md) & [DDR_Controller](../03_Memory/04_DDR_Controller.md) (the DRAM timing/IDD parameters §4.2 abstracts), [Network_on_Chip](../04_Interconnect/03_Network_on_Chip.md) & [ACE_and_CHI](../04_Interconnect/02_ACE_and_CHI.md) (the NoC/coherence fabric of §4.2), [Cache_Microarchitecture](../03_Memory/01_Cache_Microarchitecture.md) (the LLC whose sharing drives cluster contention), [Cache_Coherence](../03_Memory/05_Cache_Coherence.md) (the invalidation, ownership-transfer, directory, and false-sharing costs behind that contention).
