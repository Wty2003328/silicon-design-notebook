...
> **Hands off to:** [Simulation Methodology](../../07_Simulators/01_Methodology/01_Simulation_Methodology.md) (experiment execution), [Early PPA Estimation](../02_System_and_PPA/02_Early_PPA_Estimation_and_Uncertainty.md) (propagating workload uncertainty into design confidence), and every architecture chapter whose parameters are chosen from the resulting demand vector.
...
- **Model and execute:** [Performance Modeling and DSE](01_Performance_Modeling_and_DSE.md), [Simulation Methodology](../../07_Simulators/01_Methodology/01_Simulation_Methodology.md), and [gem5](../../07_Simulators/02_CPU_and_System/01_gem5.md).
- **Propagate confidence:** [Early PPA Estimation and Uncertainty](../02_System_and_PPA/02_Early_PPA_Estimation_and_Uncertainty.md) and [Full-Chip Modeling](../02_System_and_PPA/01_Full_Chip_Modeling.md).
- **Domain features:** [GPU Architecture](../../05_GPU/01_Core_Architecture/01_GPU_Architecture.md), [NPU Accelerators](../../06_NPU/01_Compute_Dataflows/01_NPU_Accelerators.md), and [Cache Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md).
