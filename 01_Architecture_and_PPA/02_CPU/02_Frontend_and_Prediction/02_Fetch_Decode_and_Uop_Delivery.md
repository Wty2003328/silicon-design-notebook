# Fetch, Decode, and µop Delivery — Keeping a Wide Backend Fed

> **Prerequisites:** [CPU Architecture](../01_Core_Foundations/01_CPU_Architecture.md) (pipeline and hazards), [Branch Prediction](01_Branch_Prediction_Deep_Dive.md) (next-PC prediction), and [Cache Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) (cache access and miss tracking).
...
- **Translation/cache supply:** [TLB and Virtual Memory](../../03_Memory/02_Virtual_Memory/01_TLB_and_Virtual_Memory.md), [Cache Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md).
