...
> **Prerequisites:** [OoO_Execution](../03_Out_of_Order_Backend/01_OoO_Execution.md) (the window structures and their sizing knees), [Branch_Prediction_Deep_Dive](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md) (TAGE, the FTQ, the mispredict tax), [Cache_Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) (AMAT (average memory access time), MSHR (miss-status holding register)/MLP, inclusion), [Cache_Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md) (directory scaling and ownership flow), [RISC_V_ISA](../01_Core_Foundations/02_RISC_V_ISA.md).
> **Hands off to:** [ACE_and_CHI](../../04_Interconnect/01_Protocols/02_ACE_and_CHI.md) (the coherence fabric Kunminghu moves to), [Cache_Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md) (the controller-side dual of that fabric), [AHB_AXI_APB](../../04_Interconnect/01_Protocols/01_AHB_AXI_APB.md) (TileLink/SoC integration), [Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (the design-space walk each generation performs).

---

## 0. Why this page exists

The [OoO](../03_Out_of_Order_Backend/01_OoO_Execution.md), [Branch](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md), and [Cache](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) pages give you the *models* — Little's law for the ROB, the wakeup–select recurrence for the scheduler, the $W\times P$ tax for the front end, the MSHR/MLP ceiling for the memory system. What they cannot give you is the sight of a real team **resolving those models into numbers** under a fixed target and a real area/timing budget, because that resolution normally happens inside proprietary RTL no one outside the design house ever reads.
...
A 65 %-vs-19 % split of return is not close, and it decides four generations of spending. This is the iron law ([Performance_Modeling_and_DSE §2.1](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md)) used as a compass: optimize the product, and the product points at the smaller factor — frequency.
...
| **Kunminghu** | ROB 192→256; TileLink→CHI; +vector; +BOP | MLP/window ([OoO §3.2](../03_Out_of_Order_Backend/01_OoO_Execution.md)) + coherence scaling ([ACE §3](../../04_Interconnect/01_Protocols/02_ACE_and_CHI.md)) |
| **Kunminghu v2** | IQ/LQ/SQ/MSHR up; 4→6 TAGE tables; CHI-B/C | the *last* MLP ([Cache §3.2](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md)) + accuracy ([Branch §4](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md)) |

Two meta-lessons fall out, and they are the reason to study the trajectory rather than any single snapshot:

1. **Width and depth never move; every generation spends on MLP and prediction.** Those are the levers with slope left — the miss shadow and the branch horizon still have room, while width is past the fetch-width knee (§2) and depth is fixed by the frequency target. This is the concrete shape of a design-space walk: freeze the axes that are past their knee, and pour the budget into the ones that still return ([Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md)).
...
- **Down the stack (the models this page instantiates):** [OoO_Execution](../03_Out_of_Order_Backend/01_OoO_Execution.md) (the ROB/IQ/PRF/LSQ derivations and sizing knees §5–§6 make concrete), [Branch_Prediction_Deep_Dive](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md) (the TAGE, FTQ, and $W\times P$-tax theory behind §2–§4), [Cache_Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) (AMAT, MSHR/MLP, and inclusion behind §6–§7), [Cache_Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md) (the directory and ownership-transfer model behind §7's TileLink→CHI move).
- **The exact derivation each § instantiates:** the [OoO §3.2](../03_Out_of_Order_Backend/01_OoO_Execution.md) Little's-law ROB and geometric branch-horizon (§5.1), the [OoO §2.3](../03_Out_of_Order_Backend/01_OoO_Execution.md) $N_{arch}+N_{ROB}$ PRF floor (§5.2), the [OoO §4.3](../03_Out_of_Order_Backend/01_OoO_Execution.md) $S\,W^2$ wakeup recurrence (§2, §5.3), the [OoO §5](../03_Out_of_Order_Backend/01_OoO_Execution.md) LQ/SQ window fractions (§6), the [Branch §0.2](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md) $p_{\text{miss}}^\star\propto1/(WP)$ accuracy floor and $S\propto p_{\text{miss}}^{-2}$ storage tax (§4), the [Branch §7.1–7.2](../02_Frontend_and_Prediction/01_Branch_Prediction_Deep_Dive.md) FTQ Little's law and fetch-width wall (§2–§3), the [Cache §1.2](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) recursive AMAT and [§3.2](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) MSHR Little's law (§6–§7), and the [Performance_Modeling_and_DSE §5](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) DSE budget inequality the agile trajectory runs on (§1.3, §8).
- **Up / adjacent (what this core plugs into):** [Cache_Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md) (the controller-side transient states, races, and proofs behind §7), [ACE_and_CHI](../../04_Interconnect/01_Protocols/02_ACE_and_CHI.md) (the fabric-side coherence trade-off behind the TileLink→CHI move), [AHB_AXI_APB](../../04_Interconnect/01_Protocols/01_AHB_AXI_APB.md) (TileLink and SoC integration), [TLB_and_Virtual_Memory](../../03_Memory/02_Virtual_Memory/01_TLB_and_Virtual_Memory.md) (the iTLB/dTLB in the fetch and load paths), [Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (the design-space walk §8 reads as a trajectory).
...
| **Next** | [ACE and CHI](../../04_Interconnect/01_Protocols/02_ACE_and_CHI.md) |
| **Up** | [CPU Architecture](../01_Core_Foundations/01_CPU_Architecture.md) |
| **Related** | [OoO Execution](../03_Out_of_Order_Backend/01_OoO_Execution.md) · [Cache Microarchitecture](../../03_Memory/01_Cache_Hierarchy/01_Cache_Microarchitecture.md) · [Cache Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md) · [Performance Modeling and DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) |
