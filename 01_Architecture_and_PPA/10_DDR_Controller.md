...
> **Prerequisites:** [Memory.md](09_Memory.md) (DRAM cell, sense amplifiers, refresh),
> [01_CMOS_Fundamentals.md](../00_Fundamentals/01_CMOS_Fundamentals.md) (signal integrity, timing),
> Cache_Microarchitecture.md (understanding of row buffer as cache analogy)
>
> **Hands-off to:** [AHB_AXI_APB.md](11_AHB_AXI_APB.md) (AXI bus that connects to the controller),
> [CPU_Architecture.md](03_CPU_Architecture.md) (memory stalls, OoO interaction)
...
- **Previous:** [Memory.md](09_Memory.md) -- DRAM cell design, sense amplifiers, SRAM
- **Next:** [AHB_AXI_APB.md](11_AHB_AXI_APB.md) -- AXI bus protocol connecting to the DDR controller
- **Up:** [01_CMOS_Fundamentals.md](../00_Fundamentals/01_CMOS_Fundamentals.md) -- transistor-level foundations
- **Related:** [CPU_Architecture.md](03_CPU_Architecture.md) -- how memory latency affects CPU pipeline performance
