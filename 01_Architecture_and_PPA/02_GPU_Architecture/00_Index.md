...
> **Abbreviation key — skim now and return as needed:** central processing unit (CPU); neural processing unit (NPU); system on chip (SoC); single instruction, multiple threads (SIMT); high-bandwidth memory (HBM).
...
> **First-time reader:** Start with the [Architecture Primer](../05_Architecture_Foundations_and_Methods/01_Reader_Foundations/01_Architecture_Primer_and_Glossary.md). “Warp,” “occupancy,” and “coalescing” are GPU-specific terms and are introduced from first principles in the core and memory chapters.
