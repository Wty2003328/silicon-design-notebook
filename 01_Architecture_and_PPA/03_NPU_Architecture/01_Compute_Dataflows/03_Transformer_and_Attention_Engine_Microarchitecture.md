...
Counters should report array utilization by shape, vector backlog, reduction occupancy, SRAM bank conflicts, weight bytes, KV bytes, TMA/DMA idle time, prefill/decode queue delay, and buffer-lifetime stalls.
