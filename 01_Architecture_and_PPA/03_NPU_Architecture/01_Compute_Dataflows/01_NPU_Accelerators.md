...
> **Prerequisites:** [Adders_and_Multipliers](../../../00_Fundamentals/03_Adders_and_Multipliers.md) (the MAC leaf this array is built from), [CPU_Architecture](../../01_CPU_Architecture/01_Core_Foundations/01_CPU_Architecture.md) (the von-Neumann core this page deliberately departs from), [Performance_Modeling_and_DSE §10](../../05_Architecture_Foundations_and_Methods/02_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (the systolic cycle/utilization model this page motivates in hardware terms).
...
- **Modeling and simulator companions:** [Performance_Modeling_and_DSE](../../05_Architecture_Foundations_and_Methods/02_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (operator/roofline equations), [Full_Chip_Modeling](../../04_SoC_and_Chiplet_Architecture/01_System_Modeling/01_Full_Chip_Modeling.md) (PE→array→chip→pod composition), and [Accelerator_and_NPU_Simulators](../04_Simulation/01_Accelerator_and_NPU_Simulators.md) (mapping, reuse, cycle, and energy tools).
