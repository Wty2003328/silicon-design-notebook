...
> **Prerequisites:** [AHB_AXI_APB.md](11_AHB_AXI_APB.md) (AXI4 channels and handshake rules),
> [CPU_Architecture.md](03_CPU_Architecture.md) (MESI protocol, cache hierarchy),
> [Memory.md](09_Memory.md) (SRAM/DRAM timing)
>
...
| Direction       | Link                                                    |
|-----------------|---------------------------------------------------------|
| Prerequisite    | [AHB_AXI_APB.md](11_AHB_AXI_APB.md)                     |
| Prerequisite    | [CPU_Architecture.md](03_CPU_Architecture.md)            |
| Prerequisite    | [Memory.md](09_Memory.md)                                |
| Related         | [../Implementation/01_STA.md](../06_Signoff/01_STA.md)    |
