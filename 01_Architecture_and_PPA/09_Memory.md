...
> **Prerequisites:** [CMOS_Fundamentals](../00_Fundamentals/01_CMOS_Fundamentals.md) (transistor physics, 6T SRAM cell)
> **See also:** [Cache_Microarchitecture](07_Cache_Microarchitecture.md), [DDR_Controller](10_DDR_Controller.md), [Floating_Point](../00_Fundamentals/04_Floating_Point.md) (ECC)
...
*Scope: cell physics and array design — 1T1C, sense amps, refresh mechanisms. The interface/scheduling view (DDR protocol, timing parameters, controller policies): [DDR_Controller](10_DDR_Controller.md).*
...
March algorithms (element notation, March C- walkthrough, fault models, and the fault-coverage proof) live with the rest of test: [DFT_and_ATPG](../06_Signoff/02_DFT_and_ATPG.md) §7 *Memory BIST*.
