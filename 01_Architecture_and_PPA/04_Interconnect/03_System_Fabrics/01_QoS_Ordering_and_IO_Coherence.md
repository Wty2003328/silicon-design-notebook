# QoS, Ordering, and I/O Coherence — Making a Shared Fabric Predictable

> **Prerequisites:** [AHB, AXI, and APB](../01_Protocols/01_AHB_AXI_APB.md) (channels, IDs, ordering), [ACE and CHI](../01_Protocols/02_ACE_and_CHI.md), and [Routing, Flow Control, and Deadlock](../02_Network_on_Chip/02_Routing_Flow_Control_and_Deadlock.md).
...
- **Transport/protocol:** [AHB, AXI, and APB](../01_Protocols/01_AHB_AXI_APB.md), [ACE and CHI](../01_Protocols/02_ACE_and_CHI.md), [Routing, Flow Control, and Deadlock](../02_Network_on_Chip/02_Routing_Flow_Control_and_Deadlock.md).
- **Memory controls:** [Prefetching, Replacement, and QoS](../../03_Memory/01_Cache_Hierarchy/02_Prefetching_Replacement_and_QoS.md), [DDR Controller](../../03_Memory/05_Main_Memory/01_DDR_Controller.md).
- **Devices/translation:** [Page Walkers, IOMMUs, and Virtualization](../../03_Memory/02_Virtual_Memory/02_Page_Walkers_IOMMUs_and_Virtualization.md), [Host Interface, Coherence, and Scheduling](../../06_NPU/03_System_Integration/01_Host_Interface_Coherence_and_Scheduling.md).
