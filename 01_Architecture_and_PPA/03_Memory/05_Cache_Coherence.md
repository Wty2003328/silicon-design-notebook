...
> **Prerequisites:** [CPU_Architecture](../02_CPU/01_CPU_Architecture.md) §8–§9 (the single-writer/multiple-reader (SWMR) and data-value contracts, plus the distinction between coherence and consistency), [Cache_Microarchitecture](01_Cache_Microarchitecture.md) (tags, miss-status holding registers (MSHRs), write-back, inclusion), and [AHB_AXI_APB](../04_Interconnect/01_AHB_AXI_APB.md) (requests, responses, and backpressure).
> **Hands off to:** [ACE_and_CHI](../04_Interconnect/02_ACE_and_CHI.md) (AXI Coherency Extensions (ACE) and Coherent Hub Interface (CHI): how snoop/directory transactions ride a real fabric), [Network_on_Chip](../04_Interconnect/03_Network_on_Chip.md) (routing, virtual channels, and protocol deadlock), and [gem5](../07_Simulators/02_gem5.md) §4 (executable protocol models in Ruby and the Specification Language for Implementing Cache Coherence (SLICC)).
...
This chapter bridges the gap between the protocol-level view in [CPU_Architecture §8](../02_CPU/01_CPU_Architecture.md) and the fabric-level realization in [ACE_and_CHI](../04_Interconnect/02_ACE_and_CHI.md). It answers the questions a microarchitect or verification engineer faces:
...
This is **protocol deadlock**, distinct from the channel-dependency deadlock of wormhole routing. [Network_on_Chip §4](../04_Interconnect/03_Network_on_Chip.md) supplies the routing theorem; the coherence controller must supply the message-class theorem.
...
- **Contract above this chapter:** [CPU_Architecture](../02_CPU/01_CPU_Architecture.md) §8–§9 (SWMR, data-value, and memory consistency), [RISC_V_ISA](../02_CPU/02_RISC_V_ISA.md) (RVWMO, fences, and atomics).
- **Structures inside the controller:** [Cache_Microarchitecture](01_Cache_Microarchitecture.md) (MSHRs, writeback buffers, inclusion, replacement), [Memory](03_Memory.md) (the static random-access memory (SRAM) and content-addressable memory (CAM) arrays that hold tags, directories, and transaction tables).
- **Transport below the protocol:** [ACE_and_CHI](../04_Interconnect/02_ACE_and_CHI.md) (ACE/CHI messages and home nodes), [Network_on_Chip](../04_Interconnect/03_Network_on_Chip.md) (mesh latency, virtual channels, and deadlock).
- **Executable and verifiable forms:** [gem5](../07_Simulators/02_gem5.md) §4 (Ruby/SLICC stable and transient states), [Simulation_Methodology](../07_Simulators/01_Simulation_Methodology.md) (validation and error budgets), [Formal_Verification](../../03_Frontend_RTL_and_Verification/12_Formal_Verification.md) (safety/liveness properties).
- **System clients:** [GPU_Architecture](../05_GPU/01_GPU_Architecture.md), [NPU_Accelerators](../06_NPU/01_NPU_Accelerators.md), and [DDR_Controller](04_DDR_Controller.md) (coherent accelerators and the final memory authority).
...
⬅ prev [DDR Memory Controller](04_DDR_Controller.md) · [Memory Index](00_Index.md) · [Architecture Book Contents](../00_Index.md) · next ➡ [Interconnect](../04_Interconnect/00_Index.md)
