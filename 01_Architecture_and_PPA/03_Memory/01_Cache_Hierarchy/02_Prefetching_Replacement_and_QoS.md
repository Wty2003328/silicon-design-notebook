# Prefetching, Replacement, and QoS — Managing Cache Capacity as a Prediction Problem

> **Prerequisites:** [Cache Microarchitecture](01_Cache_Microarchitecture.md) (AMAT, MSHRs, hierarchy, replacement overview), [Workload Characterization](../../01_Modeling/01_Performance_Analysis/02_Workload_Characterization_and_Sampling.md), and [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md).
> **Hands off to:** [Cache Coherence](../03_Coherence_and_Consistency/01_Cache_Coherence.md) for distributed ownership, [DDR Controller](../05_Main_Memory/01_DDR_Controller.md) for last-level misses, and [QoS, Ordering, and I/O Coherence](../../04_Interconnect/03_System_Fabrics/01_QoS_Ordering_and_IO_Coherence.md) for end-to-end enforcement.
...
- **Shared correctness and policy:** [Cache Coherence](../03_Coherence_and_Consistency/01_Cache_Coherence.md), [QoS, Ordering, and I/O Coherence](../../04_Interconnect/03_System_Fabrics/01_QoS_Ordering_and_IO_Coherence.md).
- **Traffic sinks:** [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md), [DDR Controller](../05_Main_Memory/01_DDR_Controller.md), [HBM and Advanced Memory Systems](../05_Main_Memory/02_HBM_and_Advanced_Memory_Systems.md).
...
**Navigation:** [Cache Hierarchy index](00_Index.md) · [Memory index](../00_Index.md)
