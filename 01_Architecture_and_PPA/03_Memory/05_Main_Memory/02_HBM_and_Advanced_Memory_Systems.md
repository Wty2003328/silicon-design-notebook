# HBM and Advanced Memory Systems — Buying Bandwidth with Wires, Stacks, and Parallelism

> **Prerequisites:** [DDR Controller](01_DDR_Controller.md) (banks, timing, scheduling, refresh), [Memory Arrays and Technologies](../04_Memory_Technologies/01_Memory_Arrays_and_Technologies.md), and [Network on Chip](../../04_Interconnect/02_Network_on_Chip/01_Network_on_Chip.md).
> **Hands off to:** [GPU Memory System](../../05_GPU/02_Memory_System/01_Coalescing_Caches_and_Shared_Memory.md), [NPU Tensor Tiling](../../06_NPU/02_Mapping_and_Memory/01_Tensor_Tiling_and_Data_Movement.md), and package/thermal design.
...
FR-FCFS still favors ready row hits, but accelerators add large streams and service classes. A practical scheduler considers:
...
- all JEDEC/HBM timing and power-state constraints hold;
...
- **DRAM mechanics:** [DDR Controller](01_DDR_Controller.md), [Memory Arrays and Technologies](../04_Memory_Technologies/01_Memory_Arrays_and_Technologies.md).
- **Consumers:** [GPU Memory System](../../05_GPU/02_Memory_System/01_Coalescing_Caches_and_Shared_Memory.md), [Tensor Tiling and Data Movement](../../06_NPU/02_Mapping_and_Memory/01_Tensor_Tiling_and_Data_Movement.md).
- **Package/fabric:** [Chiplets, CXL, and Die-to-Die](../../04_Interconnect/03_System_Fabrics/02_Chiplets_CXL_and_Die_to_Die.md), [IC Packaging](../../../07_Manufacturing_and_Bringup/02_IC_Packaging.md).
...
**Navigation:** [Main Memory index](00_Index.md) · [Memory index](../00_Index.md)
