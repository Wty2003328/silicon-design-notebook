...
> **Hands off to:** [Cache_Microarchitecture](../01_Cache_Hierarchy/01_Cache_Microarchitecture.md) (how these arrays are organised into caches), [Cache_Coherence](../03_Coherence_and_Consistency/01_Cache_Coherence.md) (directory, sharer, and transaction-state storage), [DDR_Controller](../05_Main_Memory/01_DDR_Controller.md) (the DRAM interface/scheduling view), [TLB_and_Virtual_Memory](../02_Virtual_Memory/01_TLB_and_Virtual_Memory.md) (the CAM of §10 in its natural home).
...
The through-line: **port count is the most expensive axis in memory design.** It is why the physical register file is a first-order area/timing constraint in an OoO core ([OoO_Execution](../../02_CPU/03_Out_of_Order_Backend/01_OoO_Execution.md) §2.3), and why width rarely exceeds 6–8.
...
- **Up the stack (what builds on these arrays):** [Cache_Microarchitecture](../01_Cache_Hierarchy/01_Cache_Microarchitecture.md) (SRAM/eDRAM organised into set-associative caches; tag CAMs), [Cache_Coherence](../03_Coherence_and_Consistency/01_Cache_Coherence.md) (SRAM/CAM structures for directory sharers and transient transaction state), [TLB_and_Virtual_Memory](../02_Virtual_Memory/01_TLB_and_Virtual_Memory.md) (the fully-associative CAM of §10), [DDR_Controller](../05_Main_Memory/01_DDR_Controller.md) (the DRAM protocol/scheduling view of §5–§6), [OoO_Execution](../../02_CPU/03_Out_of_Order_Backend/01_OoO_Execution.md) §2 (the physical register file whose port cost is §7), [NPU_Accelerators](../../06_NPU/01_Compute_Dataflows/01_NPU_Accelerators.md) & [GPU_Architecture](../../05_GPU/01_Core_Architecture/01_GPU_Architecture.md) (consumers of the CIM/near-memory of §11 and the banked register files of §7), [Performance_Modeling_and_DSE](../../01_Modeling/01_Performance_Analysis/01_Performance_Modeling_and_DSE.md) (consumes this page's DRAM latency/bandwidth and SRAM access time as the $p_{\text{mem}}$ and roofline $\beta$ of its CPI stack).
