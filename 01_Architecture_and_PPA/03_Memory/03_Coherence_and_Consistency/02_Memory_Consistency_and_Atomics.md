# Memory Consistency and Atomics — Which Cross-Core Observations Are Legal?

> **Prerequisites:** [Cache Coherence](01_Cache_Coherence.md) (single-writer/multiple-reader permissions), [CPU Architecture](../../02_CPU/01_Core_Foundations/01_CPU_Architecture.md) §9, and [Load-Store Unit](../../02_CPU/03_Out_of_Order_Backend/02_Load_Store_Unit_and_Memory_Ordering.md).
...
flowchart LR
    ...
    Model["SC / TSO / RVWMO contract"] --> Core
    Model --> Fabric
...
- **Permission protocol:** [Cache Coherence](01_Cache_Coherence.md), [ACE and CHI](../../04_Interconnect/01_Protocols/02_ACE_and_CHI.md).
- **Core machinery:** [Load-Store Unit](../../02_CPU/03_Out_of_Order_Backend/02_Load_Store_Unit_and_Memory_Ordering.md), [Retirement and Recovery](../../02_CPU/03_Out_of_Order_Backend/03_Retirement_Recovery_and_Precise_State.md).
- **I/O/translation:** [Page Walkers, IOMMUs, and Virtualization](../02_Virtual_Memory/02_Page_Walkers_IOMMUs_and_Virtualization.md), [QoS, Ordering, and I/O Coherence](../../04_Interconnect/03_System_Fabrics/01_QoS_Ordering_and_IO_Coherence.md).
...
**Navigation:** [Coherence and Consistency index](00_Index.md) · [Memory index](../00_Index.md)
