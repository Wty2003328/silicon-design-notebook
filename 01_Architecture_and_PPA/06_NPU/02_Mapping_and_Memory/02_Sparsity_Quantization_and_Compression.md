# Sparsity, Quantization, and Compression — When Fewer Bits and Zeros Become Hardware Work
...
- **Numerics/memory:** [Floating Point](../../../00_Fundamentals/04_Floating_Point.md), [HBM](../../03_Memory/05_Main_Memory/02_HBM_and_Advanced_Memory_Systems.md).
- **Simulation:** [Accelerator and NPU Simulators](../../07_Simulators/04_Accelerator_Simulation/02_Accelerator_and_NPU_Simulators.md).
