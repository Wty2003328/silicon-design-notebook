# Host Interface, Coherence, and Scheduling — Making the NPU a Safe System Agent

> **Prerequisites:** [NPU Accelerators](../01_Compute_Dataflows/01_NPU_Accelerators.md), [Tensor Tiling and Data Movement](../02_Mapping_and_Memory/01_Tensor_Tiling_and_Data_Movement.md), [Page Walkers and IOMMUs](../../03_Memory/02_Virtual_Memory/02_Page_Walkers_IOMMUs_and_Virtualization.md), and [Cache Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md).
...
A matrix engine is not a deployable accelerator. The system also needs command submission, dependency tracking, address translation, DMA/coherence, interrupts, multi-tenant scheduling, preemption, reset, errors, and observability. These “integration” blocks decide whether peak compute can be used safely.
...
- **Translation/coherence/fabric:** [Page Walkers and IOMMUs](../../03_Memory/02_Virtual_Memory/02_Page_Walkers_IOMMUs_and_Virtualization.md), [Cache Coherence](../../03_Memory/03_Coherence_and_Consistency/01_Cache_Coherence.md), [QoS, Ordering, and I/O Coherence](../../04_Interconnect/03_System_Fabrics/01_QoS_Ordering_and_IO_Coherence.md).
- **System modeling:** [Full-Chip Modeling](../../01_Modeling/02_System_and_PPA/01_Full_Chip_Modeling.md), [Accelerator and NPU Simulators](../../07_Simulators/04_Accelerator_Simulation/02_Accelerator_and_NPU_Simulators.md).
