...
- **Up the stack:** [Performance_Modeling_and_DSE §10–11](../01_Modeling/01_Performance_Modeling_and_DSE.md) (the systolic cycle/utilization model, dataflow table, and NeuSim worked example), [Full_Chip_Modeling §4](../01_Modeling/02_Full_Chip_Modeling.md) (PE→array→chip→pod power/thermal, double-buffering, collectives), [Accelerator_and_NPU_Simulators](../07_Simulators/05_Accelerator_and_NPU_Simulators.md) (how a layer + mapping becomes latency/energy — Timeloop/Accelergy, SCALE-Sim, ONNXim, NeuSim), [OoO_Execution §3](../02_CPU/03_OoO_Execution.md) (the "what must the structure hold, and why" lens this page applies to the PE).
