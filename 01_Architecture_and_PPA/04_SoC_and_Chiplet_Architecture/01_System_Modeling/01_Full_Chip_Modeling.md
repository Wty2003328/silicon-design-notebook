...
| **DSE / orchestration** | roofline + fidelity ladder ([Perf_Modeling](../../05_Architecture_Foundations_and_Methods/02_Performance_Analysis/01_Performance_Modeling_and_DSE.md)) | budget solve (§2.4) | budget solve (§2.5) |
