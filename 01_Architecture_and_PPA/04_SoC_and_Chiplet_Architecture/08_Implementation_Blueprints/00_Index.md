...
| 2 | [NoC, QoS, I/O, and Chiplet Integration](02_NoC_QoS_IO_and_Chiplet_Integration_Blueprint.md) | network-interface and packet formats, flit/VC router pipeline, credit accounting, topology sizing, protocol-level deadlock/order, admission/QoS, IOMMU/I/O, and die-to-die reliability |
