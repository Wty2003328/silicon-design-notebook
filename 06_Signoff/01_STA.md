...
How the tree is actually built — topologies (H-tree / spine / balanced tree / mesh), clock buffer selection, NDR routing rules, shielding, skew scheduling, multi-source CTS: [Physical_Design](../05_Backend_Physical_Design/01_Physical_Design.md) §4.
