...
| 13 | [Memory Consistency and Atomics](01_Architecture_and_PPA/01_CPU_Architecture/06_Coherence_and_Consistency/02_Memory_Consistency_and_Atomics.md) | The model as a contract with software; barriers, atomics, and what a weak model buys the implementation. | 8–12 |
...
| Stage 3 | 165–233 h reading + 40–60 h building → **17–24 weeks** for one architecture book | Depth in one beats breadth in four. Costed on the CPU book; the other three land within a few weeks |
| The three shelves | 327–458 h across fifteen entries, **counted in none of the rows above** | Depth on demand. Reading it early is the failure mode of §11, not diligence |
