...
> Companion to [RTL_Coding_Questions](RTL_Coding_Questions.md) (live coding). This page: the *numeric* problems (timing, power, cache, FIFO math) with full solutions, plus the snap-answer bank per domain. Sources for each derivation are linked per section.
